    ...
    public void split(TreeNode n, String[][] set, String[][] stringSet) {
        ...
        if (stringSet.length == 1) {
            ...
            for (int child = 0; child < childCount; child++) {
                ...
                HashSet<String> childClassSet = new HashSet<>();
...
//        String[][] trainingData = parseCSV("./src/newnewTrain.csv");
//        String[][] testData = parseCSV("./src/newnewTest.csv");
